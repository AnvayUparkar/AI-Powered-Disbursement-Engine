                  ...
                  {data.items.map((d) => (
                    <tr key={d.id} className="hover:bg-ink-50/50">
                      ...
                      <td className="table-cell">
                        <span className={`chip ${d.ocrStatus === 'COMPLETED' ? 'bg-verified-50 text-verified-700' : d.ocrStatus === 'PROCESSING' ? 'bg-info-50 text-info-600 animate-pulse' : 'bg-discrepancy-50 text-discrepancy-700'}`}>
                          {d.ocrStatus.charAt(0) + d.ocrStatus.slice(1).toLowerCase()}
                        </span>
                      </td>
                      <td className="table-cell">
                        <span className={`chip ${d.extractionStatus === 'COMPLETED' ? 'bg-verified-50 text-verified-700' : d.extractionStatus === 'PROCESSING' ? 'bg-info-50 text-info-600 animate-pulse' : 'bg-discrepancy-50 text-discrepancy-700'}`}>
                      ...
                      <td className="table-cell text-ink-500 font-mono text-xs whitespace-nowrap">{d.uploadedAt}</td>
                      <td className="table-cell">
